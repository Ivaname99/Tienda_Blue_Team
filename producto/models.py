...
class Producto(models.Model):
    ...
    nombre = models.CharField(null=False, max_length=50, verbose_name="Nombre Producto")
    ...
    fechaProduccion = models.DateField(null=False, verbose_name="Producción Producto")
    fechaCaducidad = models.DateField(null=False, verbose_name="Caducidad Producto")
